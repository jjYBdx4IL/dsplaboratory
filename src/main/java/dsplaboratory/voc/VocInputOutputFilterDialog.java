 ...
 * - Code Templates
 */
public class VocInputOutputFilterDialog extends FileFilter {
    ...
    public VocInputOutputFilterDialog() {
        //super();
     ...
     * @see #addExtension
     */
    public VocInputOutputFilterDialog(String extension) {
        this(extension, null);
    }

    /**
     * Creates a file filter that accepts the given file type. Example: new ExampleFileFilter("jpg", "JPEG
     * Image Images");
     *
     ...
     * @see #addExtension
     */
    public VocInputOutputFilterDialog(String extension, String description) {
        this();
        if (extension != null) {
     ...
     * @see #addExtension
     */
    public VocInputOutputFilterDialog(String[] filters) {
        this(filters, null);
    }
     ...
     * @see #addExtension
     */
    public VocInputOutputFilterDialog(String[] filters, String description) {
        this();
    ...
    /**
     * Returns the human readable description of this filter. For example: "JPEG and GIF Image Files (*.jpg,
     * *.gif)"
     *
     * @see setDescription
    ...
    /**
     * Sets the human readable description of this filter. For example: filter.setDescription("Gif and JPG
     * Images");
     *
     * @see setDescription
     * @see setExtensionListInDescription
