...
//        "Basic", "Sound", "Dummy", "Constant", "Wave", "Au / Raw", "Voc"};
    protected InputFactory[] inputFactories = new InputFactory[] {
        new dsplaboratory.basicinput.BasicInputFactory(),
        new dsplaboratory.soundinput.SoundInputFactory(),
//        new dsp.serial.SerialInputFactory(),
        new dsplaboratory.dummy.ConstantInputFactory(),
        new dsplaboratory.wave.WaveInputFactory(),
        new dsplaboratory.auraw.AuRawInputFactory(),
        new dsplaboratory.voc.VocInputFactory()};

    protected String[] filterChoices; // = new String[] {
//        "Dummy", "Mediere-Test"};
    protected FilterFactory[] filterFactories = new FilterFactory[] {
        new dsplaboratory.filters.DiscretFourierFilterFactory(),
        new dsplaboratory.filters.FourierFilterFactory(),
        new dsplaboratory.dummy.DummyFilterFactory(),
        new dsplaboratory.dummy.TestFilterFactory(),
        new dsplaboratory.dummy.MiscFilterFactory()};

    protected String[] outputChoices; // = new String[] { "Dummy", "Au / Raw"};
    protected OutputFactory[] outputFactories = new OutputFactory[] {
        new dsplaboratory.dummy.DummyOutputFactory(),
        new dsplaboratory.auraw.AuRawOutputFactory(),
        new dsplaboratory.soundinput.SoundOutputFactory(),
        new dsplaboratory.voc.VocOutputFactory()};
    ...
    protected VisualisationFactory[] visualisationFactories = new VisualisationFactory[] {
        new dsplaboratory.grafix.GrafixVisFactory(),
        new DummyVisFactory() };
