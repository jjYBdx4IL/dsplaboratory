...
public class AuOutputOptions extends JPanel {
    ...
    public JComboBox<String> SampleRateCombo;
    public JComboBox<String> SampleSizeInBitsCombo;
    public JComboBox<String> ChannelsCombo;
    public JComboBox<String> SignedCombo;
    public JComboBox<String> BigEndianCombo;
