...
//-----------------------------------------------------------------------------
   ...
   OctetCuSemn.reshape(0,10,100,20);
   JRadioButton OctetFaraSemn = new JRadioButton("Unsigned byte");
   OctetFaraSemn.reshape(0,30,120,20);
...
//-----------------------------------------------------------------------------
   ...
   eticheta2.reshape(5,60,75,20);   
   String[] Strings = {"1", "2"};
   OctetPerEsantion = new JComboBox(Strings);
   OctetPerEsantion.setSelectedIndex(0);
   OctetPerEsantion.reshape(85,60,30,20);
