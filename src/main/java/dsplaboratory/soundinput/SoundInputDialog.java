...
public class SoundInputDialog extends JDialog
{
    ...
    private JComboBox sampleRateComboBox, sampleSizeComboBox,
    ...
    private class OKAction extends AbstractAction
    {
        ...
        public void actionPerformed(ActionEvent arg0)
        {
            sampleRate = Float.parseFloat((String) sampleRateComboBox
                    .getSelectedItem());
            sampleSize = Integer.parseInt((String) sampleSizeComboBox
                    .getSelectedItem());
            channels = Integer.parseInt((String) channelNumberComboBox
                    .getSelectedItem());
    ...
    private class SetSampleSizeAction extends AbstractAction
    {
        ...
        public void actionPerformed(ActionEvent arg0)
        {
            bigEndianCheckBox.setEnabled(Integer.parseInt((String) sampleSizeComboBox
		                .getSelectedItem()) > 8);
